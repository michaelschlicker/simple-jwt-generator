...
def create_access_token_route():
    ...
    access_token = create_access_token(identity=identity, fresh=fresh, expires_delta=expires_delta, additional_claims=additional_claims, additional_headers=additional_headers)
...
def create_refresh_token_route():
    ...
    refresh_token = create_refresh_token(identity=identity, expires_delta=expires_delta, additional_claims=additional_claims, additional_headers=additional_headers)
...
def parse_timedelta(encoded_object, defaultValue):
    try:
        return timedelta(days=encoded_object.get('days'),
